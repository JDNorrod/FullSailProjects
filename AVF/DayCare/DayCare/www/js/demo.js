$('#demo').live('pageshow', function(){
    ...
    $('#researchContent').append(" " + "<p>1. What are some of the ways that you could change your HTML on your Demo app to be more accessible? (Remember, you can use the Section tag with jQuery, for instance)" + 
        "</br></br>Some of the ways to make HTML for accessible are quite easy: " + 
        ...
        "<p>2. Visit a video service on the web (like YouTube) and search for 'Screen Reader Demo' and 'Mobile Screen Reader' - what are some of the common frustrations (or common support mechanisms) that you see among the examples that are given - how could you fix them (or use them)?" + 
        ...
        "<p>4.  Mobile Apps: Please list two apps (either Android or iOS, or both) that are made specifically to support Accessibility: " + 
        "</br>The LookTel Money reader is a pretty unique application made by Ipplex that helps those who are vision impaired.  The user holds a form of currency up to the camera on the phone and LookTel will analyze and tell the user verbally what form of currency they are holding and what amount.  Come to think of it, next time I go out of country – I may download the app myself!" + 
